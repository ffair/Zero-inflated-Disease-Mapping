...
simul_art <- function(list_in){
  ...
  x[,2]=rnorm(I,0,1) 
  z_mean = c(0,0,0,0)
  z_sigma = matrix(list_in[1],nrow=4,ncol=4,byrow=TRUE)
  diag(z_sigma) = 1
  set.seed(5)
  ...
  ##The true value
  beta_true = as.matrix(c(list_in[2],0.1,-0.2,0.3,-0.4),ncol=1)
  alpha_true = as.matrix(c(list_in[3],0.5),ncol=1)
